package com.example.chapter3.features.detail.presentation
...
import com.example.chapter3.features.detail.presentation.input.IDetailViewModelInputs
import com.example.chapter3.features.detail.presentation.output.MovieDetailState
...
import com.example.chapter3.ui.components.movie.MovieMeta
import com.example.chapter3.ui.theme.Paddings
import com.example.chapter3.ui.theme.myColors
import com.example.chapter3.ui.util.getAnnotatedText
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                colors = TopAppBarDefaults.topAppBarColors(MaterialTheme.myColors.surface),
            )
        }
    ) { paddingValues ->
        Column(
