package com.example.chapter3.ui.components.dialog.components.content
...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val foregroundColor = MaterialTheme.myColors.primary.toArgb()
            val starBackgroundColor = MaterialTheme.myColors.primaryContainer.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.myColors.primaryContainer.copy(
                alpha = 0.05f
            ).toArgb()
